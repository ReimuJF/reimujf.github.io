<template>
    <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" width="2500" height="2500">
        <path class="st0" d="M0 200V0h400v400H0" style="fill: #007acc"/>
        <path class="st1" style="fill: #fff"
